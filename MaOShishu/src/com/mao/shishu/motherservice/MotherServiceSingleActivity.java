...
public class MotherServiceSingleActivity extends Activity {
	WebView webview;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.mother_service_single);
		webview = (WebView) findViewById(R.id.wv_mother_service_single);
